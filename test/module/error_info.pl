...
sub Load {
    ...
    my $messages = {
        ...
        '153' => { SUBJECT => '認証されてない', MESSAGE => 'Captcha認証をしてください。<br>専ブラからの場合は、通常ブラウザで<a href="{!AUTHURL!}">{!AUTHURL!}</a>から認証してください。' },
        ...
        '990' => { subject => 'システムエラー', message => 'システムが変です。サポート版で聞いたほうがいいかも。。' }
    };
