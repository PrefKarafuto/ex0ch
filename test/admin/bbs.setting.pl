...
sub PrintColorSetting
{
	...
	$Page->Print("<label><input type=checkbox name=BBS_HIGHLIGHT value=on $setHighlight>有効</label></td>");
	$Page->Print("<tr><td colspan=6><hr></td></tr>");
...
sub PrintLimitSetting
{
	...
	$Page->Print("<label><input type=checkbox name=NANASHI_CHECK $setNoName value=on>有効</label></td>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_DNSBL_CHECK $setDNSBL value=on $isDNSBL>$setInfo</label></td></tr>");
	$Page->Print("<tr><td class=\"DetailTitle\">スレッド作成制限(キャップ)</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_THREADCAPONLY $setCapOnly value=on>キャップのみ可能</label></td>");
	$Page->Print("<td class=\"DetailTitle\">海外ホスト規制</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_JP_CHECK $setOverSea value=on>有効</label></td></tr>");
	$Page->Print("<tr><td class=\"DetailTitle\">スレッド作成制限(携帯)</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_THREADMOBILE $setThreadMb value=on>携帯から許可</label></td>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_SAMETHREAD value=on $setSameTitle>有効</label></td>");
	$Page->Print("<td class=\"DetailTitle\">逆引き不可のIPからの投稿を制限</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_REVERSE_CHECK value=on $setReverse>有効</label></td></tr>");
	$Page->Print("<tr><td class=\"DetailTitle\">プロキシ規制</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_PROXY_CHECK value=on $setProxy>$setInfo2</label></td>");
	$Page->Print("<td class=\"DetailTitle\">完走したスレッドを落とす</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_AUTOFALL value=on $setFall>有効</label></td></tr>");
	$Page->Print("</tr>");
...
sub PrintCommandSetting
{
	...
	$Page->Print("<label><input type=checkbox name=PASS value=1 $setpass>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">スレッド最大レス（!maxres:[10-$resmax]）</td><td>");
	$Page->Print("<label><input type=checkbox name=MAXRES value=2 $setmaxres>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">extendコマンド（本文行頭!extend:[id]:[slip]:[maxres]:[maxsize]）</td><td>");
	$Page->Print("<label><input type=checkbox name=EXTEND value=1048576 $setextend>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">スレッド設定引き継ぎ（本文行頭!loadattr:[対象のスレッドID]）</td><td>");
	$Page->Print("<label><input type=checkbox name=ATTR value=8388608 $setloadattr>有効</label></td></tr>");
	$Page->Print("<tr><td colspan=4><hr></td></tr>");

	$Page->Print("<tr><td colspan=4>いつでも</td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">強制sage（!sage）</td><td>");
	$Page->Print("<label><input type=checkbox name=SAGE value=4 $setsage>有効</label></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">BBS_SLIP（!slip:[vvv/vvvv/vvvvv/vvvvvv]）</td><td>");
	$Page->Print("<label><input type=checkbox name=SLIP value=2048 $setslip>有効</label></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">ID無し（!noid）</td><td>");
	$Page->Print("<label><input type=checkbox name=NOID value=8 $setnoid>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">ID変更（!changeid）</td><td>");
	$Page->Print("<label><input type=checkbox name=CHID value=16 $setchangeid>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">名無し強制（!force774）</td><td>");
	$Page->Print("<label><input type=checkbox name=FC774 value=32 $setforce774>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">名無し変更（!change774:[名無し]）</td><td>");
	$Page->Print("<label><input type=checkbox name=CH774 value=64 $setchange774>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">書き込みが一時間なければ過去ログ送り（!live）</td><td>");
	$Page->Print("<label><input type=checkbox name=LIVE value=1024 $setlive>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">スレ主表示無し（!hidenusi）</td><td>");
	$Page->Print("<label><input type=checkbox name=NONUSI value=32768 $sethidenusi>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">強制age（!float）</td><td>");
	$Page->Print("<label><input type=checkbox name=AGE value=131072 $setfloat>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">不落（!nopool）</td><td>");
	$Page->Print("<label><input type=checkbox name=NOPOOL value=262144 $setnopool>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">忍法帖レベル制限 ※要忍法帖（!ninlv:[レベル]）</td><td>");
	$Page->Print("<label><input type=checkbox name=NINLV value=8192 $setninLv>有効</label></td></tr>");
	$Page->Print("<tr><td colspan=4><hr></td></tr>");

	$Page->Print("<tr><td colspan=4>スレッド中のみ</td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">スレッドストップ（!stop）</td><td>");
	$Page->Print("<label><input type=checkbox name=STOP value=128 $setstop>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">過去ログ送り（!pool）</td><td>");
	$Page->Print("<label><input type=checkbox name=POOL value=512 $setpool>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\"w>コマンド取り消し（!delcmd:[command]）</td><td>");
	$Page->Print("<label><input type=checkbox name=DELCMD value=256 $setdelcmd>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">アクセス禁止（!ban:[>>レス番]）</td><td>");
	$Page->Print("<label><input type=checkbox name=BAN value=4096 $setban>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">スレタイ変更（!changetitle:[新スレタイ]）</td><td>");
	$Page->Print("<label><input type=checkbox name=CHTT value=16384 $setchtt>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">追記（!add:[>>レス番]:[追記内容]）</td><td>");
	$Page->Print("<label><input type=checkbox name=ADD value=65536 $setadd>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">レス削除（!delete:[>>レス番]） </td><td>");
	$Page->Print("<label><input type=checkbox name=DELETE value=524288 $setdelete>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">副主（!sub:[>>レス番]）</td><td>");
	$Page->Print("<label><input type=checkbox name=SUB value=2097152 $setsubowner>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">強制キャップ（!cap:[>>レス番]:[キャップ名]）</td><td>");
	$Page->Print("<label><input type=checkbox name=CAP value=16777216 $setcap>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">BAN投票（!vote:[>>レス番]） </td><td>");
	$Page->Print("<label><input type=checkbox name=VOTE value=4194304 $setvoteban>有効</label></td></tr>");
	$Page->Print("<tr>");
...
sub PrintOtherSetting
{
	...
	$Page->Print("<label><input type=checkbox name=BBS_NINJA value=on $setNinja>有効</label></td>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_HIDENUSI value=on $setHideNusi>有効</label></td>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_UPLOAD value=on $setUpload disabled>Coming Soon!!</label></td>");
	...
	$Page->Print("<label><input type=checkbox name=SUBBBS_CGI_ON $setCookie value=on>確認あり</label></td></tr>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_NAMECOOKIE_CHECK $setNameCookie value=on>保存</label></td></tr>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_MAILCOOKIE_CHECK $setMailCookie value=on>保存</label></td></tr>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_PASSWORD_CHECK $setNewThread value=on disabled>別画面</label></td></tr>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_NEWSUBJECT $setConfirm value=on disabled>確認あり</label></td></tr>");
	...
	$Page->Print("<label><input type=checkbox name=BBS_IMGTAG value=on $setImage>有効</label></td></tr>");

	$Page->Print("<tr><td rowspan=5 class=\"DetailTitle\"></td><td rowspan=5>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">X(旧Twitter) 埋め込み表示</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_TWITTER value=on $setTwitter>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">Youtube/niconico 埋め込み表示</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_MOVIE value=on $setMovie>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">本文中スレURLをスレタイに変換</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_URL_TITLE value=on $setURLtoTitle>有効</label></td></tr>");
	$Page->Print("<tr>");
	$Page->Print("<td class=\"DetailTitle\">スレタイにIDを付加</td><td>");
	$Page->Print("<label><input type=checkbox name=BBS_TITLEID value=on $setTitleID>有効</label></td></tr>");
